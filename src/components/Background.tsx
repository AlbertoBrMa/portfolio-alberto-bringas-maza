...
export default function Background() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden" style={{ zIndex: 0 }}>
      ...
      {/* Capa 1 — blobs grandes, muy lentos. En claro el lima va más sutil:
          con más opacidad se percibe como una mancha verdosa, no un brillo. */}
      <motion.div style={{ y: y1 }} className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[15%] left-[10%]  w-[700px] h-[700px] rounded-full bg-[#c8ff00]/3 dark:bg-[#c8ff00]/6  blur-[160px]" />
        <div className="absolute top-[60%] right-[8%]  w-[550px] h-[550px] rounded-full bg-black/5 dark:bg-white/4      blur-[130px]" />
        <div className="absolute top-[40%] left-[50%]  w-[400px] h-[400px] rounded-full bg-[#c8ff00]/3 dark:bg-[#c8ff00]/4  blur-[100px]" />
      </motion.div>
      ...
      <motion.div style={{ y: y2 }} className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[68%]  left-[18%]  w-48 h-px  bg-gradient-to-r from-transparent via-[#c8ff00]/15 dark:via-[#c8ff00]/12 to-transparent -rotate-6" />
      </motion.div>

      {/* Capa 3 — puntos pequeños, los más rápidos */}
      <motion.div style={{ y: y3 }} className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[22%]  right-[32%] w-3  h-3  rounded-full bg-[#c8ff00]/35 dark:bg-[#c8ff00]/30" />
        <div className="absolute top-[45%]  left-[22%]  w-2  h-2  rounded-full bg-black/25 dark:bg-white/20" />
        <div className="absolute top-[65%]  right-[12%] w-4  h-4  rounded-full border border-[#c8ff00]/25 dark:border-[#c8ff00]/20" />
